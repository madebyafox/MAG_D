...
for (l in list_all) {
  ...
  #save plot
  ggsave(g, filename = paste0("plots/",level, type, topic, "_", title,".png"))
  i <- i + 1
}
...
```{r construct-clustering-dendrograms-dana}

# type = "clustering_dendograms/"
...
for (l in list_all) {
  ...
  #save plot
  # ggsave(c, filename = paste0("plots/",type,title,".png"))  
  i <- i + 1
}
...
```{r clustering-bertin-dendograms}
